...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonSinglePressUpTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonSinglePressUpTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonSinglePressUp = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonSinglePressUp(m_CachedActionName) || m_Player.GetNegativeButtonSinglePressUp(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonSinglePressUp(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonSinglePressUp(m_CachedActionName);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonSinglePressUp);
			}
		}
	}
}