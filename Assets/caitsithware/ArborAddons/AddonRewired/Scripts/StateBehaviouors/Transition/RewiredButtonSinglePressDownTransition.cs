...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonSinglePressDownTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonSinglePressDownTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonSinglePressDown = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonSinglePressDown(m_CachedActionName) || m_Player.GetNegativeButtonSinglePressDown(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonSinglePressDown(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonSinglePressDown(m_CachedActionName);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonSinglePressDown);
			}
		}
	}
}