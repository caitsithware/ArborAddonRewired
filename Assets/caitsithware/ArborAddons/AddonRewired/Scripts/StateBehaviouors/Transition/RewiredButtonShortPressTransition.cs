...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonShortPressTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonShortPressTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonShortPress = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonShortPress(m_CachedActionName) || m_Player.GetNegativeButtonShortPress(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonShortPress(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonShortPress(m_CachedActionName);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonShortPress);
			}
		}
	}
}