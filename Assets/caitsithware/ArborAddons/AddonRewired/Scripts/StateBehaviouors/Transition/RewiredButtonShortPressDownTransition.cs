...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonShortPressDownTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonShortPressDownTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonShortPressDown = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonShortPressDown(m_CachedActionName) || m_Player.GetNegativeButtonShortPressDown(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonShortPressDown(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonShortPressDown(m_CachedActionName);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonShortPressDown);
			}
		}
	}
}