...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonShortPressUpTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonShortPressUpTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonShortPressUp = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonShortPressUp(m_CachedActionName) || m_Player.GetNegativeButtonShortPressUp(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonShortPressUp(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonShortPressUp(m_CachedActionName);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonShortPressUp);
			}
		}
	}
}