...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonLongPressUpTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonLongPressUpTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonLongPressUp = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonLongPressUp(m_CachedActionName) || m_Player.GetNegativeButtonLongPressUp(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonLongPressUp(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonLongPressUp(m_CachedActionName);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonLongPressUp);
			}
		}
	}
}