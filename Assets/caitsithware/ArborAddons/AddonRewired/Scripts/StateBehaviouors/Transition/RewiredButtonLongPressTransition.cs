...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonLongPressTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonLongPressTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonLongPress = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonLongPress(m_CachedActionName) || m_Player.GetNegativeButtonLongPress(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonLongPress(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonLongPress(m_CachedActionName);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonLongPress);
			}
		}
	}
}