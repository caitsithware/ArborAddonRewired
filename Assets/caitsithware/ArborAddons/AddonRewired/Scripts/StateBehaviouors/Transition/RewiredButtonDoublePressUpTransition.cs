...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonDoublePressUpTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonDoublePressUpTransition : StateBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private StateLink m_OnButtonDoublePressUp = new StateLink();
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonDoublePressUp(m_CachedActionName, m_CachedSpeed) || m_Player.GetNegativeButtonDoublePressUp(m_CachedActionName, m_CachedSpeed);
				case AxisContributionType.Positive:
					return m_Player.GetButtonDoublePressUp(m_CachedActionName, m_CachedSpeed);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonDoublePressUp(m_CachedActionName, m_CachedSpeed);
			}
		...
		public override void OnStateUpdate()
		{
			if (CheckTransition())
			{
				Transition(m_OnButtonDoublePressUp);
			}
		}
	}
}