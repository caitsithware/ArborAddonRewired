...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("caitsithware/Rewired/RewiredButtonUpTransition")]
	[AddComponentMenu("")]
	public class RewiredButtonUpTransition : StateBehaviour
	{
		...
		{
			if (m_Player != null && !string.IsNullOrEmpty(m_CachedActionName) && m_Player.GetButtonUp(m_CachedActionName))
			{
