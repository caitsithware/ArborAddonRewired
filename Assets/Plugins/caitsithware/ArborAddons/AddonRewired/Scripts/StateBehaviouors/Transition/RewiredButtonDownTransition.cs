...
namespace caitsithware.ArborAddons.AddonRewired.StateBehaviours
{
	...
	[AddBehaviourMenu("Rewired/Transition/RewiredButtonDownTransition")]
	[AddComponentMenu("")]
		...
		bool CheckTransition()
		{
			...
			switch (m_AxisContribution)
			{
				case AxisContributionType.Any:
					return m_Player.GetButtonDown(m_CachedActionName) || m_Player.GetNegativeButtonDown(m_CachedActionName);
				case AxisContributionType.Positive:
					return m_Player.GetButtonDown(m_CachedActionName);
				case AxisContributionType.Negative:
					return m_Player.GetNegativeButtonDown(m_CachedActionName);
			}
